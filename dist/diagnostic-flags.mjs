...
export function isSkipEnabled(flag) {
 ...
 */
export function diffTableAllowList() {
...
export function activeDiagnosticFlags() {
    return Object.keys(flagEnvNames).filter(isSkipEnabled);
}
/**
 ...
 * does scan for them.
 */
const flagsThatKeepTheCheckpoint = ['skipPeriod', 'skipDiff'];
export function isSyncStripped() {
    return activeDiagnosticFlags().some(flag => !flagsThatKeepTheCheckpoint.includes(flag))
        || diffTableAllowList() != null;
}
export function logActiveDiagnosticFlags() {
...
//# sourceMappingURL=diagnostic-flags.mjs.map